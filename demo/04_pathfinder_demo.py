...
right_helix = Helix(name='Right Helix', coordinate_system=coordinate_system,
                    r=2, h=0.5, start=0, stop=np.pi * 2, right=True)
left_helix = Helix(name='Left Helix', coordinate_system=coordinate_system,
                   r=2, h=0.5, start=0, stop=np.pi * 2, right=False)
...
path = helix_between_two_points(coordinate_system, point1, point2, r=1, loops=7, right=True)
...
'''
path = arc_between_two_points(coordinate_system, point1, point2, r=1, right=True)
